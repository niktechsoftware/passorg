...
<ul class="main-navigation-menu">
    <li>
         ...
         <li>
			<a href="javascript:;">
				<i class="fa fa-credit-card"></i> <span class="title"> Shop Personal </span><i class="icon-arrow"></i> <span class="arrow "></span>
			</a>
			<ul class="sub-menu">
	    <li>
        ...
        <li>
         ...
         <li>
			<a href="javascript:;">
				<i class="fa fa-tasks"></i> <span class="title"> Manage Products </span><i class="icon-arrow"></i> 
			</a>
			<ul class="sub-menu">
				<li>
					<a href="<?php echo base_url();?>stockController/stocklist">
         ...
         <li>
            ...
            <a href="<?php echo base_url(); ?>index.php/shopController/assignproduct/">
                <i class="fa fa-money"></i><span class="title">Assign Transfer Product List </span><i class="icon-arrow"></i>
                 ...
                 <li>
                    <a href="<?php echo base_url(); ?>index.php/stockController/shop_to_other">
                      <i class="fa fa-user"></i>Transfer Shop To Other<i class="icon-arrow"></i>
                    </a>
                </li>
				<!--<li>-->
    ...
    <li>
       ...
       <li>
         ...
         <li>
			<a href="javascript:;">
				<i class="fa fa-bar-chart-o"></i> <span class="title">Order List</span><i class="icon-arrow"></i> <span class="arrow "></span>
			</a>
			<ul class="sub-menu">
	               <li>
        ...
        <li>
			<a href="javascript:;">
				<i class="fa fa-eye-slash"></i> <span class="title"> Subscriber </span><i class="icon-arrow"></i> <span class="arrow "></span>
			</a>
			<ul class="sub-menu">
